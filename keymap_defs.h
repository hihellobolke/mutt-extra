...
const char *HelpStrings[] = {
	...
	N_("edit the newsgroups list"),
	N_("edit the Reply-To field"),
	N_("edit the Followup-To field"),
	N_("edit the X-Comment-To field"),
	...
	N_("forward to newsgroup"),
	N_("forward a message with comments"),
	N_("select the current entry"),
	N_("get all children of the current message"),
	N_("get message with Message-Id"),
	N_("get parent of the current message"),
	...
	N_("load list of all newsgroups from NNTP server"),
	N_("execute a macro"),
	...
	N_("open a different newsgroup"),
	N_("open a different newsgroup in read only mode"),
	...
	N_("reconstruct thread containing current message"),
	...
	N_("subscribe to newsgroups matching a pattern"),
	...
	N_("toggle view of read messages"),
	...
	N_("go down to next mailbox with new mail"),
	N_("go to previous mailbox with new mail"),
	N_("iterate though mailboxes with new mail"),
