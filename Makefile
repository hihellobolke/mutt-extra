...
bin_PROGRAMS = mutt$(EXEEXT)  pgpring$(EXEEXT) pgpewrap$(EXEEXT)
subdir = .
DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/Makefile.am \
	$(top_srcdir)/configure $(am__configure_deps) \
	$(srcdir)/config.h.in mkinstalldirs \
	$(top_srcdir)/intl/Makefile.in $(srcdir)/hcachever.sh.in \
	$(srcdir)/muttbug.sh.in setenv.c regex.c strcasecmp.c \
	wcscasecmp.c strdup.c strtok_r.c strsep.c strcasestr.c \
	mkdtemp.c snprintf.c depcomp ABOUT-NLS ChangeLog INSTALL NEWS \
...
am_mutt_OBJECTS = addrbook.$(OBJEXT) alias.$(OBJEXT) attach.$(OBJEXT) \
	...
	compress.$(OBJEXT) commands.$(OBJEXT) complete.$(OBJEXT) \
	...
	rfc2231.$(OBJEXT) rfc3676.$(OBJEXT) score.$(OBJEXT) \
	...
	lib.$(OBJEXT) sidebar.$(OBJEXT) muttlib.$(OBJEXT) \
...
MSGFMT = :
MUTTLIBS =  -lncurses  -lncurses -dynamic -Wl,-search_paths_first -lkrb5 -lssl -lcrypto -lz -lsasl2  -ltokyocabinet
MUTT_LIB_OBJECTS =  pgp.o pgpinvoke.o pgpkey.o pgplib.o gnupgparse.o pgpmicalg.o pgppacket.o crypt-mod-pgp-classic.o smime.o crypt-mod-smime-classic.o resize.o dotlock.o pop.o pop_lib.o pop_auth.o smtp.o bcache.o account.o mutt_socket.o mutt_tunnel.o mutt_ssl.o mutt_sasl.o hcache.o md5.o mutt_idna.o
MUTT_MD5 = mutt_md5
OBJEXT = o
...
VERSION = 1.5.23
XGETTEXT = :
abs_builddir = /Volumes/home/epiclulz/Documents/workspace/github/mutt-extra
abs_srcdir = /Volumes/home/epiclulz/Documents/workspace/github/mutt-extra
abs_top_builddir = /Volumes/home/epiclulz/Documents/workspace/github/mutt-extra
abs_top_srcdir = /Volumes/home/epiclulz/Documents/workspace/github/mutt-extra
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /Volumes/home/epiclulz/Documents/workspace/github/mutt-extra/install-sh
...
bin_SCRIPTS = muttbug flea smime_keys
...
mutt_LDADD =  pgp.o pgpinvoke.o pgpkey.o pgplib.o gnupgparse.o pgpmicalg.o pgppacket.o crypt-mod-pgp-classic.o smime.o crypt-mod-smime-classic.o resize.o dotlock.o pop.o pop_lib.o pop_auth.o smtp.o bcache.o account.o mutt_socket.o mutt_tunnel.o mutt_ssl.o mutt_sasl.o hcache.o md5.o mutt_idna.o  $(LIBIMAP) $(MUTTLIBS) \
	$(INTLLIBS) $(LIBICONV)  $(GPGME_LIBS)

mutt_DEPENDENCIES =  pgp.o pgpinvoke.o pgpkey.o pgplib.o gnupgparse.o pgpmicalg.o pgppacket.o crypt-mod-pgp-classic.o smime.o crypt-mod-smime-classic.o resize.o dotlock.o pop.o pop_lib.o pop_auth.o smtp.o bcache.o account.o mutt_socket.o mutt_tunnel.o mutt_ssl.o mutt_sasl.o hcache.o md5.o mutt_idna.o  $(LIBIMAPDEPS) \
	$(INTLDEPS)
...
LDADD =  $(top_builddir)/intl/libintl.a -liconv
...
mutt$(EXEEXT): $(mutt_OBJECTS) $(mutt_DEPENDENCIES) $(EXTRA_mutt_DEPENDENCIES) 
	@rm -f mutt$(EXEEXT)
	$(AM_V_CCLD)$(LINK) $(mutt_OBJECTS) $(mutt_LDADD) $(LIBS)
...
#include $(DEPDIR)/wcscasecmp.Po
#include ./$(DEPDIR)/account.Po
#include ./$(DEPDIR)/addrbook.Po
#include ./$(DEPDIR)/alias.Po
#include ./$(DEPDIR)/ascii.Po
#include ./$(DEPDIR)/attach.Po
#include ./$(DEPDIR)/base64.Po
#include ./$(DEPDIR)/bcache.Po
#include ./$(DEPDIR)/browser.Po
#include ./$(DEPDIR)/buffy.Po
#include ./$(DEPDIR)/charset.Po
#include ./$(DEPDIR)/color.Po
#include ./$(DEPDIR)/commands.Po
#include ./$(DEPDIR)/complete.Po
#include ./$(DEPDIR)/compose.Po
#include ./$(DEPDIR)/compress.Po
#include ./$(DEPDIR)/conststrings.Po
#include ./$(DEPDIR)/copy.Po
#include ./$(DEPDIR)/crypt-gpgme.Po
#include ./$(DEPDIR)/crypt-mod-pgp-classic.Po
#include ./$(DEPDIR)/crypt-mod-pgp-gpgme.Po
#include ./$(DEPDIR)/crypt-mod-smime-classic.Po
#include ./$(DEPDIR)/crypt-mod-smime-gpgme.Po
#include ./$(DEPDIR)/crypt-mod.Po
#include ./$(DEPDIR)/crypt.Po
#include ./$(DEPDIR)/cryptglue.Po
#include ./$(DEPDIR)/curs_lib.Po
#include ./$(DEPDIR)/curs_main.Po
#include ./$(DEPDIR)/date.Po
#include ./$(DEPDIR)/dotlock.Po
#include ./$(DEPDIR)/edit.Po
#include ./$(DEPDIR)/editmsg.Po
#include ./$(DEPDIR)/enter.Po
#include ./$(DEPDIR)/extlib.Po
#include ./$(DEPDIR)/filter.Po
#include ./$(DEPDIR)/flags.Po
#include ./$(DEPDIR)/from.Po
#include ./$(DEPDIR)/getdomain.Po
#include ./$(DEPDIR)/gnupgparse.Po
#include ./$(DEPDIR)/group.Po
#include ./$(DEPDIR)/handler.Po
#include ./$(DEPDIR)/hash.Po
#include ./$(DEPDIR)/hcache.Po
#include ./$(DEPDIR)/hdrline.Po
#include ./$(DEPDIR)/headers.Po
...
#include ./$(DEPDIR)/mbox.Po
#include ./$(DEPDIR)/mbyte.Po
#include ./$(DEPDIR)/md5.Po
#include ./$(DEPDIR)/menu.Po
#include ./$(DEPDIR)/mh.Po
#include ./$(DEPDIR)/mutt_dotlock.Po
#include ./$(DEPDIR)/mutt_idna.Po
#include ./$(DEPDIR)/mutt_md5-md5.Po
#include ./$(DEPDIR)/mutt_sasl.Po
#include ./$(DEPDIR)/mutt_socket.Po
#include ./$(DEPDIR)/mutt_ssl.Po
#include ./$(DEPDIR)/mutt_ssl_gnutls.Po
#include ./$(DEPDIR)/mutt_tunnel.Po
#include ./$(DEPDIR)/muttlib.Po
#include ./$(DEPDIR)/mx.Po
#include ./$(DEPDIR)/newsrc.Po
#include ./$(DEPDIR)/nntp.Po
#include ./$(DEPDIR)/pager.Po
#include ./$(DEPDIR)/parse.Po
#include ./$(DEPDIR)/patchlist.Po
#include ./$(DEPDIR)/pattern.Po
#include ./$(DEPDIR)/pgp.Po
#include ./$(DEPDIR)/pgpewrap.Po
#include ./$(DEPDIR)/pgpinvoke.Po
#include ./$(DEPDIR)/pgpkey.Po
#include ./$(DEPDIR)/pgplib.Po
#include ./$(DEPDIR)/pgpmicalg.Po
#include ./$(DEPDIR)/pgppacket.Po
#include ./$(DEPDIR)/pgppubring.Po
#include ./$(DEPDIR)/pop.Po
#include ./$(DEPDIR)/pop_auth.Po
#include ./$(DEPDIR)/pop_lib.Po
#include ./$(DEPDIR)/postpone.Po
#include ./$(DEPDIR)/query.Po
#include ./$(DEPDIR)/recvattach.Po
#include ./$(DEPDIR)/recvcmd.Po
#include ./$(DEPDIR)/remailer.Po
#include ./$(DEPDIR)/resize.Po
#include ./$(DEPDIR)/rfc1524.Po
#include ./$(DEPDIR)/rfc2047.Po
#include ./$(DEPDIR)/rfc2231.Po
#include ./$(DEPDIR)/rfc3676.Po
#include ./$(DEPDIR)/rfc822.Po
#include ./$(DEPDIR)/safe_asprintf.Po
#include ./$(DEPDIR)/score.Po
#include ./$(DEPDIR)/send.Po
#include ./$(DEPDIR)/sendlib.Po
#include ./$(DEPDIR)/sha1.Po
#include ./$(DEPDIR)/sidebar.Po
#include ./$(DEPDIR)/signal.Po
#include ./$(DEPDIR)/smime.Po
...
#	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mutt_md5_CFLAGS) $(CFLAGS) -MT mutt_md5-md5.o -MD -MP -MF $(DEPDIR)/mutt_md5-md5.Tpo -c -o mutt_md5-md5.o `test -f 'md5.c' || echo '$(srcdir)/'`md5.c
#	$(AM_V_at)$(am__mv) $(DEPDIR)/mutt_md5-md5.Tpo $(DEPDIR)/mutt_md5-md5.Po
#	$(AM_V_CC)source='md5.c' object='mutt_md5-md5.o' libtool=no 
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) 
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mutt_md5_CFLAGS) $(CFLAGS) -c -o mutt_md5-md5.o `test -f 'md5.c' || echo '$(srcdir)/'`md5.c

mutt_md5-md5.obj: md5.c
#	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mutt_md5_CFLAGS) $(CFLAGS) -MT mutt_md5-md5.obj -MD -MP -MF $(DEPDIR)/mutt_md5-md5.Tpo -c -o mutt_md5-md5.obj `if test -f 'md5.c'; then $(CYGPATH_W) 'md5.c'; else $(CYGPATH_W) '$(srcdir)/md5.c'; fi`
#	$(AM_V_at)$(am__mv) $(DEPDIR)/mutt_md5-md5.Tpo $(DEPDIR)/mutt_md5-md5.Po
#	$(AM_V_CC)source='md5.c' object='mutt_md5-md5.obj' libtool=no 
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) 
	$(AM_V_CC)$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(mutt_md5_CFLAGS) $(CFLAGS) -c -o mutt_md5-md5.obj `if test -f 'md5.c'; then $(CYGPATH_W) 'md5.c'; else $(CYGPATH_W) '$(srcdir)/md5.c'; fi`
...
install-exec-hook:
	...
	if test -f $(DESTDIR)$(bindir)/mutt_dotlock && test x != x ; then \
		chgrp  $(DESTDIR)$(bindir)/mutt_dotlock && \
		chmod 755 $(DESTDIR)$(bindir)/mutt_dotlock || \
